class Asari
  # Public: This module should be included in any class including
  # Mongoid::Document that needs to be indexed. Every time this module is
  ...
  module Mongoid
    ...
    module ClassMethods
      ...
      # Asari::Mongoid, or your methods will be very sad.
      #
      ...
      # to the caller; override this method on your mongoid document object to
